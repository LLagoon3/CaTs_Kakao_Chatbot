"""
Django settings for kakao_chatbot project.
...
SECRET_KEY = 'django-insecure-sk%oa2$**vomw@g&jpgp!d9s&zam83foi6!xkbl2jy-6ta01!a'
...
ROOT_URLCONF = 'kakao_chatbot.urls'
...
WSGI_APPLICATION = 'kakao_chatbot.wsgi.application'
